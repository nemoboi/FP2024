...
The main characters in-game controlled by the players.

They can only run, jump, push things and interact with buttons, switches and portals.
...
The way to move between levels

## Player

The two people infront of the screen controlling the Blobs
